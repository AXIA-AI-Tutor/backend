...
public enum ErrorCode {
    ...
    DOCUMENT_SUMMARY_NOT_ALLOWED(HttpStatus.CONFLICT, "DOCUMENT_SUMMARY_NOT_ALLOWED", "문서 요약 생성 가능한 상태가 아닙니다."),
    DOCUMENT_SUMMARY_ALREADY_EXISTS(HttpStatus.CONFLICT, "DOCUMENT_SUMMARY_ALREADY_EXISTS", "이미 요약이 생성된 문서입니다."),
    DOCUMENT_SUMMARY_EMPTY(HttpStatus.BAD_GATEWAY, "DOCUMENT_SUMMARY_EMPTY", "AI 문서 요약 결과가 비어 있습니다."),
    DOCUMENT_FILE_NOT_FOUND(HttpStatus.BAD_REQUEST, "DOCUMENT_FILE_NOT_FOUND", "문서 파일을 스토리지에서 찾을 수 없습니다."),
    DOCUMENT_TEXT_EXTRACT_FAILED(HttpStatus.BAD_REQUEST, "DOCUMENT_TEXT_EXTRACT_FAILED", "문서 텍스트 추출에 실패했습니다."),
    DOCUMENT_TEXT_EMPTY(HttpStatus.BAD_REQUEST, "DOCUMENT_TEXT_EMPTY", "추출된 문서 텍스트가 비어 있습니다."),
